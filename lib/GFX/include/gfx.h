...
namespace Gfx
{
	constexpr GLuint GLTypeSize(const GLenum e);
}

///////////////////////////////////////////////////////////////////////////////////////////////////
/// API - GLCallTerminateImpl
///////////////////////////////////////////////////////////////////////////////////////////////////
namespace Gfx
{
	namespace Detail
	{
		void GLCallTerminateImpl();
	}
}
///////////////////////////////////////////////////////////////////////////////////////////////////
/// API - GL_Call
...
#define GFX_MAP_TYPE_SIZE_GENERATOR(Enum, Type) case Enum: return sizeof(Type);
		switch (type)
		{
			...
			GFX_MAP_TYPE_SIZE_GENERATOR(GL_BYTE, GLbyte);
			GFX_MAP_TYPE_SIZE_GENERATOR(GL_UNSIGNED_BYTE, GLubyte);
			GFX_MAP_TYPE_SIZE_GENERATOR(GL_SHORT, GLshort);
			GFX_MAP_TYPE_SIZE_GENERATOR(GL_UNSIGNED_SHORT, GLushort);
			GFX_MAP_TYPE_SIZE_GENERATOR(GL_INT, GLint);
			GFX_MAP_TYPE_SIZE_GENERATOR(GL_INT_2_10_10_10_REV, GLint);
			GFX_MAP_TYPE_SIZE_GENERATOR(GL_UNSIGNED_INT, GLuint);
			GFX_MAP_TYPE_SIZE_GENERATOR(GL_UNSIGNED_INT_2_10_10_10_REV, GLuint);
