...
ParticleSystem::ParticleSystem( 
        ...
        ) : GraphicsComponent(gameObject, ID),
...
void ParticleSystem::launchParticle(int i)
{
    ...
    {
    case insideCirle:
        pos[i] =    m_gameObject->m_transform.getWorldPos();
        rot[i] =    glm::vec3(0, 0, OK::Util::random(0, glm::radians(360.0f)));
        scl[i] =    glm::vec3(m_cfg.startSize);
        vel[i] =    glm::normalize(glm::vec3(OK::Util::random(0,1), OK::Util::random(0,1), 0)) * m_cfg.startSpeed;
